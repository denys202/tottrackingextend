...
namespace Tottrackingextend\Utils;
...
{
    public function getViteVariables(?string $entryPoint = null): array
    {
        $js = [];
        $css = [];
        $jsEntry = '';
        $filesystem = new Filesystem();
        $path = '/modules/tottrackingextend/views/';
        ...
        if ($filesystem->exists($buildDir)) {
            ...
            if (is_null($entryPoint)) {
                ...
                $manifestProcessor = new ViteManifest($manifest, $buildDirHttps);
