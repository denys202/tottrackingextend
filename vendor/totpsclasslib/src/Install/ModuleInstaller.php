...
use TottrackingextendClasslib\Install\AbstractInstaller;
use TottrackingextendClasslib\Install\ExtensionInstaller;
use Configuration;
use Db;
use DbQuery;
use Hook;
...
{
    const INSTALL_MODULE_TABS_HOOK = 'actionInstallTottrackingextendTabs';

    const UNINSTALL_MODULE_TABS_HOOK = 'actionUninstallTottrackingextendTabs';
